...
export const OwnWritesLogo: React.FC<{ className?: string; title: string }> = ({ className, title }) => (
    <svg viewBox="0 0 300 40" xmlns="http://www.w3.org/2000/svg" className={className} aria-label={`${title} logo`}>
      <style>
        {`.ownwrites-text-logo { font-family: 'Lora', serif; font-size: 32px; font-weight: bold; }`}
      </style>
      <text x="0" y="30" className="ownwrites-text-logo" fill="currentColor">{title}</text>
    </svg>
);
...
export const InkwellLogo = OwnWritesLogo;
